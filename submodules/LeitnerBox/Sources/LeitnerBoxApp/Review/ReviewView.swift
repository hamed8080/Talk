...
struct ReviewView: View {
    ...
    var body: some View {
        if viewModel.isFinished {
            ...
            .leitnerBoxCustomDialog(isShowing: $viewModel.showDelete) {
                DeleteDialog()
                    .environmentObject(viewModel)
            }
            .onDisappear {
    ...
    struct Preview: View {
        ...
        var body: some View {
            ReviewView(viewModel: viewModel)
                ...
                .environmentObject(LeitnerBoxObjectsContainer(context: Preview.context, leitner: Preview.leitner, leitnerVM: leitnerVM))
        }
    }
