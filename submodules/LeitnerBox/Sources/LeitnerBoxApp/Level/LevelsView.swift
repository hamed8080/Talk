...
struct LevelsView: View {
    let container: LeitnerBoxObjectsContainer
...
struct LevelsToolbarView: View {
    @EnvironmentObject var container: LeitnerBoxObjectsContainer
    ...
    var body: some View {
        ...
        ToolbarNavigation(title: "Statictics", systemImageName: "chart.xyaxis.line") {
            if let context = container.leitnerVM.viewContext as? NSManagedObjectContext {
                StatisticsView()
...
struct LevelsView_Previews: PreviewProvider {
    struct Preview: View {
        static let context = MockDatabase.shared.viewContext
        ...
        var body: some View {
            LevelsView(container: LeitnerBoxObjectsContainer(context: Preview.context, leitner: Preview.leitner, leitnerVM: leitnerViewModel))
