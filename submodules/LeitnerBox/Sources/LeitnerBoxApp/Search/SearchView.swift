...
struct SearchView_Previews: PreviewProvider {
    struct Preview: View {
        ...
        var body: some View {
            SearchView(container: LeitnerBoxObjectsContainer(context: Preview.context, leitner: Preview.leitner, leitnerVM: LeitnerViewModel(viewContext: Preview.context)))
