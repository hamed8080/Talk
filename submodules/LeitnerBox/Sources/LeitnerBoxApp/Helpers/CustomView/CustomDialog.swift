...
struct CustomDialog_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {}
            ...
            .leitnerBoxCustomDialog(isShowing: .constant(true)) {
                VStack {
...
extension View {
    func leitnerBoxCustomDialog<DialogContent: View>(isShowing: Binding<Bool>, @ViewBuilder content: @escaping () -> DialogContent) -> some View {
